        ...
        <div id="question-container" className="bni">
              ...
              <div className="">
                <div className="ng jt pr pw ia bol">
                  <span className="bac bvy bcj">
                    Your Appointment Selection
                  </span>
                </div>
                <div>
                  <p className="">Appointment Selection</p>
                </div>
                <div className="yu bvh bok bpi ta tj">
                  <div className="ho boo col-12">
                    <div
                      data-ivisa-slug="appointment_location_id"
                      data-ivisa-question-selector="applicant.0.appointment_location_id"
                      className=""
                    >
                      <div className="">
                        <label className="by jt pr v2-space-x-8">
                          <span>
                            You&apos;ll need to attend an appointment. Please
                            enter your address to find the nearest appointment
                            location.
                          </span>
                        </label>
                        <div className="dq">
                          <div>
                            <div>
                              ...
                              <div className="jd rt bdm bac jt vx us">
                                <span className="is jr">
                                  <div className="js">
                                    <svg
                                      className="mf kh "
                                      width="30"
                                ...
                                <div>
                                  <div className="hr">
                                    <span className="ix">
                                      We estimate that applicants who select
                                      this location get their visa in:
                                      <br />
                                    </span>
                                    <span className="bdo">
                                      Less Than 1 Month
          ...
          <div className="jt pr bpq brt fq bqd">
            ...
            <div
              ...
              // onClick={() => navigate("/a/australia/step=step_4")}
            >
